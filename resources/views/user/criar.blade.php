...
<h1 class="title-pg">
    ...
    {{$title or 'Cadastro de Colaborador'}}
</h1>
...
@endif
    ...
    <div class="form-group">
        E-mail:
        <input type="email" name="email" class="form-control" value="{{$user->email or old('email')}}" placeholder="Preenchimento Obrigatório" required>
    </div>
    ...
    <div class="form-group">
        ...
        @else
            Senha:
            <input type="text" name="password" class="form-control" value="" placeholder="Preenchimento Obrigatório" required>
        @endif
    </div>

    <div class="form-group">
        Porcentagem de Comissão:
        <input type="number" min="0" name="valorPorcentagem" class="form-control" placeholder="Preenchimento Obrigatório" value="{{$user->valorPorcentagem or old('valorPorcentagem')}}" required>
    </div>
...
@section('js')
    <script>
        function msg(){
            var nomeColaborador = document.form1.name.value; 

            var pergunta = confirm("Deseja continuar com o registro do colaborador (" + nomeColaborador + ") ?");
            if(!pergunta){
